...
if core.get_modpath("ethereal") then
	...
	core.register_craftitem("caverealms:angler_rod_baited", {
		...
		on_use = function(itemstack, user, pointed_thing)
			...
			if
				(node == "default:water_source" or node == "default:river_water_source")
				and math.random(1, 100) < 35
			then
				...
				if inv:room_for_item("main", { name = type }) then
					...
					core.chat_send_player(user:get_player_name(), "Inventory full, Fish Got Away!")
				end
			end
		end,
	})
